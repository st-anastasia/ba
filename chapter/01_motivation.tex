...
Auch im Zeitalter der Smartphone hat sich an den Grundprinzipien und Protokollen, die das World Wide Web seit 1991 zu Nutze macht, nicht viel geändert. Eine sog. Single Page Webpplikation wird vom Browser auf die gleiche Art und Weise geladen, wie die allererste HTML Webseite. Lediglich eine grundlegende Neuerung kam im Jahr 1995 hinzu. Netscape ermöglichte es, den Entwicklern mehr Interaktivität durch Auslieferung vom Script Code in die statischen Webseiten einzubauen, und leitete den Aufstieg von JavaScript - gegenwärtig einer der populärsten Programmiersprachen - ein. Allerdings ist diese Berühmtheit ganz und gar nicht dadurch entstanden, dass die Sprache eine besonders elegante Erfindung war. Es war einfach die einzige von Browsern von Haus aus unterstützte Option. Ganz im Gegenteil, JavaScript basiert auf einigen schlechten Entscheidungen. Ein populäres Fachbuch nennt sich auch daher nicht umsonst - \enquote{JavaScript - the good parts}.
