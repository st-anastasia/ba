...
\section{Motivation}
 ...
 \enquote{There is no cloud it's just someone else's Computer} - eigentlich ein ganz
 triviales Statement, doch es wurde zu einem Internetphänomen, auch \enquote{Meme}
...
Spezialisten sprechen von einem \enquote{Second Screen}, aber in Wirklichkeit ist
...
\enquote{Like all gold rushes, they must come to an end. It is clear that everyone
...
Es stellt sich daher eine Situation dar, in der die Anwender zwar die schnelle
...
Auch im Smartphone Zeitalter hat sich an den Grundprinzipien und
...
\enqoute{JavaScript is a language with more than its share of bad parts. It went from nonexistence
